...
const Navbar = () => {
  ...
  return (
    <nav className="bg-white dark:bg-github-canvas-subtle shadow-md dark:shadow-none border-b border-gray-200 dark:border-github-border" style={{ fontFamily: '"Minecraftia", sans-serif' }}>
